...
//        if(convertView==null){
          ...
          /*  String hurtstate_str="--";
            ...
            Long risklevel_long=Long.valueOf(mData.get(position).getAsString(TaskDS.risklevel));
            if(risklevel_long==0){
                risklevel_str="无风险";
                holder_yds.risklevel.setTextColor(mContext.getResources().getColor(R.color.typegreen));
            }else if(risklevel_long>0){
                risklevel_str="风险案件";
                holder_yds.risklevel.setTextColor(mContext.getResources().getColor(R.color.typered));
            }
        ...
        if(rolestate_long==1){
            ...
            holder_yds.riskstate.setVisibility(View.GONE);
        }
