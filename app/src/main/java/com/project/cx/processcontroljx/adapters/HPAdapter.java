...
/*            String hurtstate_str="--";
            ...
            if(risklevel_long==0){
                risklevel_str="无风险";
                holder_hp.risklevel.setTextColor(mContext.getResources().getColor(R.color.typegreen));
            }else if(risklevel_long>0){
                risklevel_str="风险案件";
                holder_hp.risklevel.setTextColor(mContext.getResources().getColor(R.color.typered));
            }
